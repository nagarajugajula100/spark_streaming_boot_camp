...
class Bronze():
    ...
    def process(self):
        ...
        sQuery =  ( invoicesDF.writeStream
                            ...
                            .outputMode("append")
                            .toTable("spark_catalog.stream_db.invoices_bz")           
                    ) 
        print("Done")
        return sQuery   
...
class Gold():
    ...
    def readBronze(self):
        return spark.readStream.table("spark_catalog.stream_db.invoices_bz")
    ...
    def saveResults(self, results_df):
        ...
        return (results_df.writeStream
                    ...
                    .outputMode("complete")
                    .toTable("spark_catalog.stream_db.customer_rewards")
                )
        print("Done")
